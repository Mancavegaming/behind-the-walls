...
public class AbnormalTitanGlowLayer extends RenderLayer<AbnormalTitanEntity, AbnormalTitanModel> {
    private static final ResourceLocation GLOW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(BeyondTheWalls.MODID, "textures/entity/abnormal_titan_glow.png");

    public AbnormalTitanGlowLayer(RenderLayerParent<AbnormalTitanEntity, AbnormalTitanModel> renderer) {
        super(renderer);
    }

    @Override
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight,
                       AbnormalTitanEntity entity, float limbSwing, float limbSwingAmount,
